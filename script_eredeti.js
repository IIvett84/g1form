console.log("Üdvözöllek a weboldalon!");
...
(function ($) {
    ...
    $(document).on("change", 'select[name="type"]', function () {
      ...
      if (target !== "") {
        ...
        $.each(packs[target], function (index, value) {
          ...
          if (defaultLang) html += index + "</option>";
          else html += value.eng + "</option>";
        });
        ...
        if (target === "Normál futam") {
          if ($(".checkbox-holder .padder2").length === 0) {
            if (defaultLang) chkName = "Feldobox kuponnal rendelkezem";
            else chkName = "I have Feldobox coupon";
            ...
            chkInput +=
              '<label class="neutral" for="feldobox">' + chkName + "</label>";
        ...
        if (target === "Céges futam") {
          ...
          if ($(".company-holder .padder2").length === 0) {
            if (defaultLang) cmpName = "Cégnév";
            else cmpName = "Company name";
  ...
  $(document).on("submit", ".booking", function () {
    ...
    if (error) {
      ...
      if (defaultLang) tomail = packs[selType][selPack].addressHu;
      else tomail = packs[selType][selPack].addressEn;
  ...
  $(document).on("click", ".pack-loader-opener", function () {
    ...
    if (selType !== "" && selPack !== "" && selPack !== "Csomag nélkül") {
      ...
      if (defaultLang) var href = siteUrl + "" + packs[selType][selPack].link;
      else var href = siteUrl + "" + packs[selType][selPack].linken;
